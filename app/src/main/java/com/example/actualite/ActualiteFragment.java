...
public class ActualiteFragment extends Fragment {
  ...
  // Function to show the DescriptionFragment when a actualite is clicked
  private void showDescriptionFragment(Actualite actualite) {
    DescriptionFragment descriptionFragment = new DescriptionFragment();
    Bundle bundle = new Bundle();
    bundle.putInt("actualiteId", actualite.getId()); // Use "actualiteId" as the key to match the retrieval in DescriptionFragment
